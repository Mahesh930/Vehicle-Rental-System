                ...
                <div className="w-full sm:w-1/2 p-4 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-600 rounded-3xl shadow-xl opacity-90">
                    ...
                    <div className="flex flex-col gap-4 items-center mt-4">
                        <button
                            ...
                            className="mt-4 px-5 py-2 w-36 bg-pink-600 text-white font-bold rounded-lg hover:bg-pink-500 transition duration-200 transform hover:scale-105"
                        >
                            Edit Profile
                        </button>
                        <button
                            ...
                            >
                                ...
                                <div className="flex flex-col justify-between">
                                    ...
                                    <p className="text-white text-base">
                                        ...
                                        {rental.rentDate} at {rental.rentTime}
                                    </p>
                                    <p className="text-white text-base">
                                        <strong>Return Date:</strong>{" "}
                                        {rental.returnDate} at{" "}
                                        {rental.returnTime}
                                    </p>
