        ...
        >
            <div className="max-w-6xl flex flex-col md:flex-row items-center space-y-10 md:space-y-0 md:space-x-12">
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center text-center md:text-left">
                    ...
                    >
                        At ChalJauu, we redefine convenience by offering a
                        seamless connection to a diverse fleet of vehicles
                        tailored to your needs. With our focus on quality and
                        affordability, we ensure every rental is effortless,
                        reliable, and designed to exceed expectations.
                    </p>
                    <p
                    ...
                    >
                        Whether you’re planning a weekend getaway or need a
                        vehicle for a business trip, our diverse fleet has you
                        covered. With reliability, comfort, and style at the
                        heart of our service, you can explore your destination
                        with complete peace of mind. Choose ChalJauu—your
