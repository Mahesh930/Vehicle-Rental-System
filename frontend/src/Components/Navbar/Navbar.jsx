        ...
        <div className="navbar-end">
          ...
          <Link to="cart-page">
            <div
              tabIndex={0}
              role="button"
              className="btn btn-ghost btn-circle mr-3 lg:flex hidden flex item-center justify-center"
            >
          ...
          {user ? (
            ...
            <button
              ...
              className="btn bg-[#1d4ed8] rounded-full px-6 text-white flex items-center gap-2"
            >
              <FaRegUser />
              Login
            </button>
